...
const solutions = [
  ...
  {
    name: "Automated Investment Adjustments",
    description: "Speak directly to your customers",
    href: "#",
  },
];
        ...
        <div className="flex flex-wrap justify-between items-center mx-auto px-4 xl:max-w-screen-xl">
          ...
          <div className="flex lg:hidden">
            <div className="pr-3">
              <Button
                asChild
                className="text-md font-semibold dark:bg-white dark:hover:bg-gray-300"
              >
          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            ...
            <Button
              asChild
              className="text-md dark:text-black font-semibold dark:bg-white dark:hover:bg-gray-300"
            >
              <Link href="/auth/login">Log in</Link>
            </Button>
